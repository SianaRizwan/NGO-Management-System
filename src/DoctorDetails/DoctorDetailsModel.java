...
public class DoctorDetailsModel {
    ...
    protected void getSpeciality(ObservableList<String> list) {
    ...
    protected void isDeleteDoctorSuccessful(String id) {
        try {
            OracleConnection oc=new OracleConnection();
            ...
            System.out.println(e + "  DoctorModel  /// isDeleteDoctorSuccessful");
            e.printStackTrace();
        }
    }
