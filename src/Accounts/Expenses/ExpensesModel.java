...
public class ExpensesModel {
    protected ObservableList<Expenses> getExpensesTableRecords() throws SQLException {
        String sql = "select expenses_id, type, title, description, amount,expense_date from expenses order by expenses_id";
    ...
    protected boolean isExpenseUpdateSuccessful(String expId, String expType, String expTitle,String expDescription,int amount,Date expDate){
        try {
            ...
            ps.setString(3,expTitle);
            ps.setString(4,expDescription);
            ps.setInt(5,amount);
